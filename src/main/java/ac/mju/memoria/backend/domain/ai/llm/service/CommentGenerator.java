...
public interface CommentGenerator {
        @SystemMessage("""
                                ...
                                The 'content' of the letter MUST be formatted using **Markdown**.
                                This means:
                                -   Paragraphs should be separated by a blank line (which translates to a double newline character, e.g., '\\n\\n').
                                -   You can use other Markdown features like *italics* for emphasis, **bold** for strong emphasis, or lists (using '-' or '*') if it fits your character and the message. However, the primary requirement is proper paragraph structure resulting in a multi-line letter.
                                -   Ensure your output for the letter's content is valid Markdown that will render correctly with clear paragraph breaks. Do NOT return the entire letter content as a single, unbroken line of text.
                                ...
                                -   **Ensure the letter content is generated in Markdown format. Paragraphs must be separated by blank lines. This will result in a well-structured, multi-paragraph letter that is easy to read.**
